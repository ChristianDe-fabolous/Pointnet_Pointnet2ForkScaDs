...
from data_utils.ScaDsDataLoader import ScaDSDataLoader
...
def parse_args():
    ...
    parser.add_argument('--num_category', default=5, required=True, type=int,  help='training on ModelNet10/40')
    ...
    parser.add_argument('--log_dir', type=str, default='pointnet2_cls_sgg', help='experiment root')
